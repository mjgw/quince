<?php /* Smarty version 2.6.9, created on 2006-09-26 21:44:17
...
<div style="width:100%;border:1px solid #ccc" align="center">
  <div style="width:800px;text-align:left;border:1px solid #ccc;background-color:#fff;margin-top:50px;padding:15px" align="left" class="text">
		<a href="http://www.visudo.com/quince"><img style="text-align:right" src="<?php echo $this->_tpl_vars['domain']; ?>
Resources/Images/quince_small.gif" /></a><br/>
